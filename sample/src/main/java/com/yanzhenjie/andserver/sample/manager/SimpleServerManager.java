package com.yanzhenjie.andserver.sample.manager;
...
import com.yanzhenjie.andserver.sample.SimpleService;

public class SimpleServerManager extends BroadcastReceiver {
    ...
    public SimpleServerManager(MainActivity activity) {
        this.mActivity = activity;
        mService = new Intent(activity, SimpleService.class);
    }
