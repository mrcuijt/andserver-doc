...
public class DocListHandler extends DispatcherHandler {
    public static final String NAME = "doc-list";

    private final Context mContext;

    public DocListHandler(Context mContext) {
        super(mContext);
    ...
    public void handle(HttpRequest request, HttpResponse response){
        ...
        List<List<FileModel>> list3 = WebDocUtil.generateGroupListByFileType(list2);
